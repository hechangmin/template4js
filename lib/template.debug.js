...
function template(){
    ...
    function compile(source){
        var strFn = "var _$jstpl='',__fn__=(function(__d__){var __v__='';for(var __k__ in __d__){__v__+=('var '+__k__+'=__d__[\"'+__k__+'\"];');};eval(__v__);_$jstpl+='" + preParse(source) + "';__v__=null;})(param);__fn__ = null;return _$jstpl;";
